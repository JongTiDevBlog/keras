...
x1_val, x1_test, x2_val, x2_test, y1_val, y1_test, y2_val, y2_test, y3_val, y3_test = train_test_split(x1_test, x2_test, y1_test, y2_test, y3_test, train_size = 0.6, random_state=66, shuffle=False)
...
model.fit([x1_train, x2_train], [y1_train, y2_train, y3_train], epochs=100, batch_size=1, validation_data=([x1_val, x2_val], [y1_val, y2_val, y3_val]), callbacks=[early_stopping, tb_hist])
